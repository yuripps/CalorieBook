...
import com.example.yuripps.caloriebook.EditCalorieItemActivity;
...
import static com.example.yuripps.caloriebook.db.DatabaseHelper.FRUIT_TABLE;
...
public class FruitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHelper = new DatabaseHelper(FruitActivity.this);
        ...
        addCalorie.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(FruitActivity.this,AddCalorieActivity.class);
    ...
    private void loadPhoneData() {
        ...
        Cursor c = mDb.query(FRUIT_TABLE, null, null, null, null, null, null);
    ...
    private void setupListView() {
        ...
        lv.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, final int position, long l) {
                ...
                new AlertDialog.Builder(FruitActivity.this)
                        .setItems(items, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                switch (i) {
                                    case 0: // Edit
                                        Intent intent = new Intent(FruitActivity.this, EditCalorieItemActivity.class);
