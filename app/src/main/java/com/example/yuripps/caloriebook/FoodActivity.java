...
import static com.example.yuripps.caloriebook.db.DatabaseHelper.FOOD_TABLE;
...
public class FoodActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHelper = new DatabaseHelper(FoodActivity.this);
        ...
        addCalorie.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(FoodActivity.this,AddCalorieActivity.class);
    ...
    private void loadPhoneData() {
        ...
        Cursor c = mDb.query(FOOD_TABLE, null, null, null, null, null, null);
                ...
                new AlertDialog.Builder(FoodActivity.this)
                        .setItems(items, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                switch (i) {
                                    case 0: // Edit
                                        Intent intent = new Intent(FoodActivity.this, EditCalorieItemActivity.class);
